...
from models.repmobile import RepMobile
...
def get_args_parser():
    parser = argparse.ArgumentParser(
        'RepMobile training and evaluation script', add_help=False)
    parser.add_argument('--batch-size', default=256, type=int)
    parser.add_argument('--epochs', default=300, type=int)

    # Model parameters
    parser.add_argument('--model', default='RepMobile_L', type=str, metavar='MODEL',
...
def main(args):
    ...
    if args.model=="RepMobile_M":
        model= RepMobile(dims=[80,160,320,640], layers=[3,6,15,3], ClaSiLU=[1,1,1,1],distillation=(args.distillation_type != 'none'))
    elif args.model=="RepMobile_S":
        model= RepMobile(dims=[64,128,256,512], layers=[3,6,12,3], ClaSiLU=[1,1,1,1],distillation=(args.distillation_type != 'none'))
    elif args.model=="RepMobile_L":
        model= RepMobile(dims=[96,192,384,768], layers=[4,8,20,8], ClaSiLU=[1,1,1,1],distillation=(args.distillation_type != 'none'))
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        'RepMobile training and evaluation script', parents=[get_args_parser()])
